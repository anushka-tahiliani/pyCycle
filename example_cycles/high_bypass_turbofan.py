...
#         self.pyc_add_cycle_param('duct4.dPqP',0)
...
#         self.pyc_add_cycle_param('byp_bld.bypBld:frac_W', 0) #0.020274
#         self.pyc_add_cycle_param('byp_nozz.Cv', 0.9939)
#         self.pyc_add_cycle_param('hpc.cool1:frac_W', 0) #0.050708
#         self.pyc_add_cycle_param('hpc.cool1:frac_P', 0.5)
#         self.pyc_add_cycle_param('hpc.cool1:frac_work', 0.5)
#         self.pyc_add_cycle_param('hpc.cool2:frac_W', 0) #0.020274
...
#         self.pyc_add_cycle_param('hpc.cust:frac_W', 0) #0.0445
...
#     viewer_file = open('hbtf_view_AIAA_baseline.out', 'w')
#     first_pass = True
...
#             plot_compressor_maps(prob, ['OD_part_pwr.hpc'])
